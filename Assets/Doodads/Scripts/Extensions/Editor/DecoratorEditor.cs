...
namespace Doodads.Editor
{
	...
	public abstract class DecoratorEditor : Editor
	{
		...
		/// </summary>
		readonly Type decoratedEditorType;

		/// <summary>
		/// Type object for the object that is edited by this editor.
		/// </summary>
		Type editedObjectType;

		Editor editorInstance;


		static readonly Dictionary<string, MethodInfo> decoratedMethods = new Dictionary<string, MethodInfo>();
